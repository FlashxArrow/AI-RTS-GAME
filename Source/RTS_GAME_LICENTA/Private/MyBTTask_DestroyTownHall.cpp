#include "MyBTTask_DestroyTownHall.h"
...
UMyBTTask_DestroyTownHall::UMyBTTask_DestroyTownHall()
{
    NodeName = TEXT("Destroy TownHall!");

    // Set the default class for TrooperClass
    ConstructorHelpers::FClassFinder<AActor> TrooperBPClass(TEXT(""));
...
EBTNodeResult::Type UMyBTTask_DestroyTownHall::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
