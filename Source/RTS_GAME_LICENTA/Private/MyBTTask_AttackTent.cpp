...
UMyBTTask_AttackTent::UMyBTTask_AttackTent()
{
    NodeName = TEXT("Attack Tent!");
...
EBTNodeResult::Type UMyBTTask_AttackTent::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
